      ...
      <ul class="navbar-nav ms-auto mb-0 mb-lg-0 align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="dropdown-item" href="/rapide">Teste Rapide</a></li>
            <li><a class="dropdown-item" href="/cromogen">Medii cromogene</a></li>
            <li><a class="dropdown-item" href="/nutrient">Medii nutriente</a></li>
            <li><a class="dropdown-item" href="/laborator">Echipamente laborator</a></li>
          </ul>
        </li>
        <li class="nav-item">
